...
var choice_height : int = 40 # Choice label's height
var choice_width : int = 450 # Choice label's width
...
var text_alignment : String = "right"
...
var frame_height : int = 250 # Dialog frame height (in pixels)
